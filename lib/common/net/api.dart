...
class HttpManager {
  ...
  Future<ResultData> netFetch(
    ...
    resultError2(SignUpResponse e) {
      return new ResultData(
          Code.errorHandleFunction(e.code, e.message, noTip),
          false,
          e.code);
    }
    ...
    SignUpResponse resultData = SignUpResponse.fromJson(response.data.data);
    if(resultData.code!=0){
      return resultError2(resultData);
    }
