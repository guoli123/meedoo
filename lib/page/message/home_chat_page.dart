...
import 'package:gsy_github_app_flutter/page/message/conversation.dart' show Conversation;
                ...
                children: <Widget>[
                  Expanded(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration.collapsed(hintText: "what do you want to say?"),
                      autocorrect: true,
                      //是否自动更正
                      autofocus: false,
                  ...
                  new IconButton(
                    //发送按钮
                      icon: new Icon(Icons.insert_emoticon,size:24), //发送按钮图标
                  ...
                  new Container(
                    ...
                    child: new IconButton(
                      //发送按钮
                        icon: new Icon(Icons.add_circle_outline), //发送按钮图标
                        onPressed: () => _handleSubmitted(
